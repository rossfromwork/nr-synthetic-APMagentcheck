...
var countOfOutdatedAgents = 0; // Initialize the count of out-of-date agents
...
// Log the API key and account ID being used
//console.log("Using API key:", apiKey);
//console.log("Using account ID:", accountId);

// Make the NerdGraph API request to get the list of agent versions
makeNerdGraphRequest(DocsAgentOptions, DocsAgentQuery, function(error, DocsAgentData) {
  if (error) {
  ...
  makeNerdGraphRequest(apmAgentOptions, apmAgentQuery, function(error, apmAgentData) {
    if (error) {
    ...
    countOfOutdatedAgents = apmAgents.reduce(function(count, agentVersion) {
